      ...
      <GridContainer className="flex flex-col items-center">
        <div className="w-full max-w-text-hero text-center opacity-0" ref={textHeroRef}>
          ...
          <div className="flex items-center justify-center gap-10">
            ...
            <button className="py-4 px-5 bg-green-btn text-green-primary font-bold">Começar agora</button>
          </div>
        ...
        <div className="relative w-full max-w-area-icons h-28 mt-4">
          ...
          <Image src={IconHand02} alt="Icon Hand 02" className="absolute top-0 right-0"/>
        </div>
        <div className="absolute -bottom-44 w-full max-w-area-mockups flex justify-between">
          <Image src={IconMockup} alt="Mockup" className="relative  top-[1.125rem] left-[3.3125rem]" ref={mockupLeftRef}/>
          <Image src={IconMockup} alt="Mockup" className="relative  top-[1.125rem] right-[3.3125rem]"  ref={mockupRightRef}/>
        </div>
